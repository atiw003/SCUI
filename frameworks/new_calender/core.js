...
// SCUI.GRANULARITY values
SCUI.YEAR_GRANULARITY   = 'year' ;
SCUI.MONTH_GRANULARITY  = 'month' ;
SCUI.WEEK_GRANULARITY   = 'week' ;
SCUI.DAY_GRANULARITY    = 'day' ;
SCUI.HOUR_GRANULARITY   = 'hour' ;
SCUI.MINUTE_GRANULARITY = 'year' ;
SCUI.SECOND_GRANULARITY = 'second' ;
...
In general, a calendar makes arbitrary calendar events available to a calendar
layout for rendering. Because each record stores date information under 
unknown keys, developers must be allowed to specify the 'firstDateTimeKey' and
...
- all day, December 1, 2009:
  - first: December 1, 12:00:00 AM, 2009
  - following: December 2, 12:00:00 AM, 2009

- the entire month of February, 2010
  - first: February 1, 12:00:00 AM, 2010
  - following: March 1, 12:00:00 AM, 2010
...
overlapsCalendarInPeriod(calendar, first, following), which either returns NO, 
...
2. By overriding overlapsCalendarInPeriod() in your SC.Record instance that can
...
This architecture is loosly based on the Cocoa Text System. For more 
