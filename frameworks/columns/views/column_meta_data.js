//============================================================================
// SCUI.ColumnMetaDataView
//============================================================================
/*globals SC*/

/**

  This is just a basic meta data view for a single item in an SCUI.ColumnView
...
SCUI.ColumnMetaDataView = SC.View.extend(SC.ContentDisplay,
  /** @scope SCUI.ColumnMetaDataView.prototype */{
