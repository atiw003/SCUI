...
/** @class
  ...
  The Column Set View uses an SCUI.ColumnView For Each Column.
...
SCUI.ColumnSetView = SC.View.extend(
/** @scope SC.ColumnSetView.prototype */ {
  
  classNames: ['scui-column-set-view'],
   ...
   */
  exampleColumnView: SCUI.ColumnView,
   ...
   */
  exampleDividerView: SCUI.DividerView,
  
  /**
   * The meta data view for a single item
   */
  exampleMetaDataView: SCUI.ColumnMetaDataView,
