...
module("SCUI.Statechart: With Parallel States - Goto State Intermediate Tests", {
  setup: function() {
          ...
          c: SCUI.State2.design({
            ...
            g: SCUI.State2.design({
              ...
              j: SCUI.State2.design({
                initialSubstate: 'p',
                p: SCUI.State2.design(),
                q: SCUI.State2.design()
              }),
              
              k: SCUI.State2.design({
                initialSubstate: 'r',
                r: SCUI.State2.design(),
                s: SCUI.State2.design()
              })
            })
